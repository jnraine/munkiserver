# Determine and set path to image magick
path = nil
...
if path.nil?
  logger.warn("Unable to determine the path to image magick.  If Paperclip errors, set the path manually in config/initializers/paperclip.rb")
else
